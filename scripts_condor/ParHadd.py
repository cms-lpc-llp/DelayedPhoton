...
parser.add_argument('--tempdir',
    type=str,
    default="/storage/user/qnguyen/DelayedPhoton/CMSSW_10_6_12/src/DelayedPhoton/scripts_condor/tmp/",
...
if __name__ == "__main__":
    ...
    print("glob query: ", remaining_args[1])
    infiles = glob(remaining_args[1])
    print(infiles)
