...
ouputfilepath=/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021Feb17/EcalTimeSmearing_2018UL/MC/
isData=no
...
ouputfilepath=/mnt/hadoop/store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021Feb17/EcalTimeSmearing_2018/MC/
isData=no
...
do
	...
	do
		...
		echo "Arguments = ${analyzer}_${sample}_Job${jobnumber}_Of_${maxjob}  ${analyzer} ${inputfilelist} no 10 ${filesPerJob} ${jobnumber} ${sample}_Job${jobnumber}_Of_${maxjob}.root" >> ${jdl_file}
