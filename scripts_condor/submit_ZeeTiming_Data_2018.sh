...
do
	...
	do
        ...
        echo "Arguments = ${analyzer}_${sample}_Job${jobnumber}_Of_${maxjob} /store/group/phys_llp/ZeeTiming/2018/jobs ${analyzer} ${inputfilelist} yes 10 ${filesPerJob} ${jobnumber} ${sample}_Job${jobnumber}_Of_${maxjob}.root" >> ${jdl_file}
		...
		echo "x509userproxy = \$ENV(X509_USER_PROXY)" >> ${jdl_file}
                ...
                echo "+JobBatchName = \"${sample}_ZeeTiming"\" >> ${jdl_file}
