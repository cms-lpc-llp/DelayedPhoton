 ...
 if (nPho >= 1) // require at least one photon
 {
	...
	if(!isData && nPho>=2) //for two neutralino -> photon + gravitino signal MC studies only
	{
		...
		if(foundN1==1 && foundN2==1 && foundN3==1 && foundN4==1)
		{
			...
			float deltaPt23 = fabs(pho3Pt - gpho2Pt);
			float deltaPt24 = fabs(pho4Pt - gpho2Pt);
			...
			float deltaR13 = genSeed1.DeltaR(recoSeed3);
			float deltaR14 = genSeed1.DeltaR(recoSeed4);

			float deltaR21 = genSeed2.DeltaR(recoSeed1);
			float deltaR22 = genSeed2.DeltaR(recoSeed2);
			float deltaR23 = genSeed2.DeltaR(recoSeed3);
			float deltaR24 = genSeed2.DeltaR(recoSeed4);
