...
file_data = TFile("/storage/cms/store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021May3/hadd/EGamma_Run2018D.root")
...
for i in range(0, N_Run_points):
	...
	myC.SaveAs(outputDir+"/fits/iRunFit_Zee_"+str(i)+"_dt_data.png")
...
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_Run_sigma_Data_2016.pdf")
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_Run_sigma_Data_2016.png")
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_Run_sigma_Data_2016.C")

file_out = TFile(outputDir+"/TimingReso_Zee_dt_vs_Run_sigma_Data_2016.root","RECREATE")
