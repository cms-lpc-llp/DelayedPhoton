...
lumi = 26900.0  # for 2018ABC, 26.9 fb-1
outputDir = "/storage/af/user/yeseo/DelayedPhoton/CMSSW_10_6_20/src/DelayedPhoton/EcalTimingCorrection"
outputDir = ""+outputDir+"/Timing_vs_E/ZeeTiming_2018ABC"
...
os.system("mkdir -p "+outputDir+"/fits")
os.system("cp Timing*.py "+outputDir+"/")
#################plot settings###########################
axisTitleSize = 0.06
axisTitleOffset = .8
...
file_data = TFile("/storage/cms/store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021May3/hadd/EGamma_Run2018ABC.root")
tree_data = file_data.Get("ZeeTiming")

file_MC = TFile("/storage/cms/store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021May3/hadd/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8.root")
...
for i in range(0, N_E_points):
	...
	myC.SaveAs(outputDir+"/fits/iEFit_Zee_"+str(i)+"_time_data.png")
	hist_2e_this_data.Draw()
	result_2e_this_data = doubGausFit(hist_2e_this_data)#, -1.5, 1.5, 0.2, 0.4) 
	myC.SaveAs(outputDir+"/fits/iEFit_Zee_"+str(i)+"_dt_data.png")
	...
	myC.SaveAs(outputDir+"/fits/iEFit_Zee_"+str(i)+"_time_MC.png")
	hist_2e_this_MC.Draw()
	result_2e_this_MC = doubGausFit(hist_2e_this_MC)#, -1.0, 1.0, 0.15, 0.30) 
	myC.SaveAs(outputDir+"/fits/iEFit_Zee_"+str(i)+"_dt_MC.png")
	...
	myC.SaveAs(outputDir+"/fits/iEFit_Zee_"+str(i)+"_time_MC_corr.png")
	hist_2e_this_MC_corr.Draw()
	result_2e_this_MC_corr = doubGausFit(hist_2e_this_MC_corr)#, -1.0, 1.0, 0.15, 0.30) 
	myC.SaveAs(outputDir+"/fits/iEFit_Zee_"+str(i)+"_dt_MC_corr.png")
...
myC.SaveAs(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016_noCorr.pdf")
myC.SaveAs(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016_noCorr.png")
myC.SaveAs(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016_noCorr.C")
gr_E_mean_data.Draw("AP")
...
myC.SaveAs(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016_Corr.pdf")
myC.SaveAs(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016_Corr.png")
myC.SaveAs(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016_Corr.C")

file_plot_shift = TFile(outputDir+"/TimingShift_Zee_vs_E_Data_vs_MC_2016.root","RECREATE")
...
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016_noCorr.pdf")
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016_noCorr.png")
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016_noCorr.C")
gr_E_sigma_dt_data.Draw("AP")
gr_E_sigma_dt_MC_corr.Draw("Psame")
gr_E_sigma_dt_diff_corr.Draw("Psame")
leg_sigma_dt.Draw()
drawCMS(myC, 13, lumi)
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016_Corr.pdf")
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016_Corr.png")
myC.SaveAs(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016_Corr.C")



file_plot_dt = TFile(outputDir+"/TimingReso_Zee_dt_vs_E_Data_vs_MC_2016.root", "RECREATE")
...
myC.SaveAs(outputDir+"/TimingReso_Zee_time_vs_E_Data_vs_MC_2016_noCorr.pdf")
myC.SaveAs(outputDir+"/TimingReso_Zee_time_vs_E_Data_vs_MC_2016_noCorr.png")
myC.SaveAs(outputDir+"/TimingReso_Zee_time_vs_E_Data_vs_MC_2016_noCorr.C")
...
leg_sigma_time.Draw()
drawCMS(myC, 13, lumi)
myC.SaveAs(outputDir+"/TimingReso_Zee_time_vs_E_Data_vs_MC_2016_Corr.pdf")
myC.SaveAs(outputDir+"/TimingReso_Zee_time_vs_E_Data_vs_MC_2016_Corr.png")
myC.SaveAs(outputDir+"/TimingReso_Zee_time_vs_E_Data_vs_MC_2016_Corr.C")
