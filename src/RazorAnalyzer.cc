...
bool RazorAnalyzer::photonPassTightIso_OOT2017(int i){
	...
	bool phopassIso_ecal = pho_ecalPFClusterIso[i]  < 5.0 + 0.00301*phoPt[i] + 0.1324*fixedGridRhoFastjetAll*(std::copysign(0.5, 0.8-abs(phoEta[i]))+0.5) + (0.0864*fixedGridRhoFastjetAll+0.8206)*(std::copysign(0.5, abs(phoEta[i])-0.8)+0.5);
	...
	bool phopassIso_hcal = pho_sumNeutralHadronEt[i]  < 4.0 - 0.0058*phoPt[i] + 2.92e-05*phoPt[i]*phoPt[i] + 0.1094*fixedGridRhoFastjetAll*(std::copysign(0.5, 0.8-abs(phoEta[i]))+0.5) + (0.0939*fixedGridRhoFastjetAll-2.2)*(std::copysign(0.5, abs(phoEta[i])-0.8)+0.5);
	...
	bool phopassIso_tracker = pho_trkSumPtHollowConeDR03[i] < 4.0 + 0.0227*fixedGridRhoFastjetAll*(std::copysign(0.5, 0.8-abs(phoEta[i]))+0.5) +  0.0054*fixedGridRhoFastjetAll*(std::copysign(0.5, abs(phoEta[i])-0.8)+0.5);
