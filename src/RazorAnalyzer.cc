...
bool RazorAnalyzer::photonPassTightIso_OOT2017(int i){
	...
	bool phopassIso_hcal = pho_hcalPFClusterIso[i]  < 4.0 - 0.0058*phoPt[i] + 2.92e-05*phoPt[i]*phoPt[i] + 0.1094*fixedGridRhoFastjetAll*(std::copysign(0.5, 0.8-abs(phoEta[i]))+0.5) + (0.0939*fixedGridRhoFastjetAll-2.2)*(std::copysign(0.5, abs(phoEta[i])-0.8)+0.5);
